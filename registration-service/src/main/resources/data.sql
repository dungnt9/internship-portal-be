...
INSERT INTO internship_progress (id, student_ref_id, position_id, period_id, teacher_ref_id, start_date, end_date, is_external, external_id, status, supervisor_name, supervisor_position, supervisor_email, supervisor_phone, teacher_confirmed, teacher_confirmed_at, created_at, updated_at) VALUES
                                                                                                                                                                                                                                                                                                    (1, 2, 3, 1, 1, '2025-06-01', '2025-08-01', false, null, 'ONGOING', 'Trần Văn Hùng', 'Senior Developer', 'hung.tv@viettel.com.vn', '0912345680', true, DATE_SUB(NOW(), INTERVAL 3 DAY), NOW(), NOW()),
                                                                                                                                                                                                                                                                                                    (2, 3, 2, 1, 2, '2025-06-01', '2025-08-01', false, null, 'ONGOING', 'Nguyễn Thị Hương', 'Frontend Team Lead', 'huong.nt@fpt.com.vn', '0912345678', true, DATE_SUB(NOW(), INTERVAL 3 DAY), NOW(), NOW()),
                                                                                                                                                                                                                                                                                                    (3, 6, 3, 1, 3, '2025-06-01', '2025-08-01', false, null, 'ONGOING', 'Trần Văn Hùng', 'Senior Developer', 'hung.tv@viettel.com.vn', '0912345680', true, DATE_SUB(NOW(), INTERVAL 3 DAY), NOW(), NOW()),
                                                                                                                                                                                                                                                                                                    (4, 7, 4, 1, 4, '2025-06-01', '2025-08-01', false, null, 'ONGOING', 'Nguyễn Văn Thắng', 'Web Development Lead', 'thang.nv@vnpt.com.vn', '0912345682', true, DATE_SUB(NOW(), INTERVAL 3 DAY), NOW(), NOW()),
                                                                                                                                                                                                                                                                                                    (5, 8, null, 1, 1, '2025-06-01', '2025-08-01', true, 1, 'ONGOING', 'Nguyễn Văn An', 'Technical Lead', 'an.nv@teko.vn', '0912345698', true, DATE_SUB(NOW(), INTERVAL 3 DAY), NOW(), NOW());