        ...
        try {
            ...
            return ResponseEntity
                    ...
                    .body(ApiResponse.<List<ExternalInternshipDTO>>builder()
                            ...
                            .message("An error occurred while retrieving external internships: " + e.getMessage())
                            .data(null)
                            .build());
        }
    }
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.CREATED)
                    .body(ApiResponse.<ExternalInternshipDTO>builder()
                            ...
                            .message("External internship application created successfully")
            ...
            return ResponseEntity
                    ...
                    .body(ApiResponse.<ExternalInternshipDTO>builder()
                            .status(HttpStatus.INTERNAL_SERVER_ERROR.value())
                            .message("An error occurred while creating external internship: " + e.getMessage())
                            .data(null)
                            .build());
        }
    }
